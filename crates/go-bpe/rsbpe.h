...
/* Create a DeepSeek V3.2 tokenizer. Caller owns the returned pointer. */
RsBpeTokenizer *rsbpe_new_deepseek_v32(void);
...
/* Free a tokenizer handle returned by any rsbpe_new_* constructor. */
